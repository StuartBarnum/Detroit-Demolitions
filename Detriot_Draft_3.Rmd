...
formula <- blighted ~ total_fines_by_parcel + number_of_violations_by_parcel + 
    improve_issues_tallies + earlier_recorded_crime_incidents + later_recorded_crime_incidents +
    total_acre + council_di + frontage + num_vacant_parcels
...
formula <- blighted ~ total_fines_by_parcel + number_of_violations_by_parcel + 
    improve_issues_tallies + earlier_recorded_crime_incidents + later_recorded_crime_incidents +
    total_acre + council_di + frontage + num_vacant_parcels + num_nearby_blighted_parcels
...
formula <- blighted ~ total_fines_by_parcel + number_of_violations_by_parcel + 
    improve_issues_tallies + earlier_recorded_crime_incidents + total_acre + council_di + frontage +
    num_vacant_parcels + num_nearby_blighted_parcels + sum_fines_nearby_parcels + 
    num_violations_nearby_parcels

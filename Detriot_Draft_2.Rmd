...
#construct a of pridictor values and then represent the predictions with colors
library(modelr)
...
ggplot(grid) + geom_point(aes(x = number_of_violations_by_parcel, 
                              y = total_fines_by_parcel, color = pred > .5))


ggplot(grid) + geom_histogram(aes(x = pred))

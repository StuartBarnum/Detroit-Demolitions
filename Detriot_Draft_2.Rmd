...
We now construct a balanced set of labels, with roughly equal numbers of blighted and non-blighted examples. We then divide this set into a training set, an initial test set (which can be used for any number of tests), and a final test set, to be withheld for a final test of our final model.

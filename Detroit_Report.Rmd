...
The code and exporatory graphics used in the above anaysis can be found at https://stuartbarnum.github.io/Detroit-Demolitions/Detriot_Draft_3.html
...
The rather weak but significant association between the irredeamable blight of a building and blight-related citations can also be seen in the following plot.
...
complete_tally_set %>% filter(num_nearby_blighted_parcels < 20 & num_vacant_parcels < 200) %>%
  ggplot() + stat_summary_2d(aes(x = num_nearby_blighted_parcels,
                                 y = num_vacant_parcels,
                                 z = as.numeric(blighted)), 
                             bins = 15) +
  ggtitle("Distribution of Blightedness over num_nearby_blighted_parcels \nand num_vacant_parcels") +
  theme(plot.title = element_text(hjust = 0.5)) +

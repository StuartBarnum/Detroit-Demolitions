...
I should note that all of the models generated in the above k-fold cross-validation process have the same form as does the above decision-tree model (with somewhat different break points, such as with 52.5 instead of 50.5 at node 4). Plotted in a proper decision-tree format (with, again, "1" standing for *blighted* and "0" standing for "not blighted"), the model appears as follows.

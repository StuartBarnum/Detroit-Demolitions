...
Having identifies some potentially problematic data points, I we need to investigate a few of them. As in the following example.
...
Using Google Street View to investigate a few of the dismantle permit entries for which there are other entries with the same parcel number but different addresses, suggests that most of these repeats are for addresses that share a building, or at least for are attached.
